...
public class Pedido {
  ...
  public Pedido cliente(@javax.annotation.Nullable Cliente cliente) {
  ...
  public void setCliente(@javax.annotation.Nullable Cliente cliente) {
    this.cliente = cliente;
  }


  public Pedido fecha(@javax.annotation.Nullable LocalDate fecha) {
    this.fecha = fecha;
    return this;
  }
  ...
  public Pedido numero(@javax.annotation.Nullable Integer numero) {
    this.numero = numero;
    return this;
  }

...
public class Pantalla2View extends JPanel {
	/**
	 * 
	 */
	...
	public Pantalla2View(App appController) {
		...
		add(btnIrAPantalla2);
		btnIrAPantalla2.setEnabled(false);

		JButton btnIrPantalla3 = new JButton("Ir a pantalla 3");
		btnIrPantalla3.setBounds(389, 260, 123, 21);
		add(btnIrPantalla3);
		btnIrPantalla3.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				appController.mostrarPantalla3(textField.getText());
			}
		});
